        ...
        <div class="flex flex-col justify-center">
            <div
                ...
                <div class="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
                    ...
                    <h3 class="font-black text-gray-800 md:text-md text-md">The Majestic and Wonderful Bahamas</h3>
                    <p class="md:text-md text-gray-500 text-base">The best kept secret of The Bahamas is Lorem, ipsum dolor....</p>
                    <button class="btn btn-sm btn-primary text-white">
                        
                        <span class="font-normal text-base">Read more </span>
                    </button>
                </div>
            </div>
        </div>
